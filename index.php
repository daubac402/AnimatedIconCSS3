...
<!-- Animated Icons -->
<ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-8395820335361202" data-ad-slot="4553495373"></ins>
<script>
...
<div class="icon thunder-storm-sunny">
    <div class="cloud"></div>
    <div class="sun">
        <div class="rays"></div>
    </div>
...
<div class="icon rainy">
    <div class="cloud"></div>
    <div class="rain"></div>
    <div class="lightning when_rainy">
        <div class="bolt"></div>
        <div class="bolt"></div>
    </div>
</div>
...
<div class="icon compass">
    <div class="compass_ring"></div>
    <div class="compass_key"></div>
</div>
